...
const RegisterForm = () => {
	...
	// nunca se ejecuta por algun motivo el onsubmit. Hay que arreglarlo.
			...
			<div className="flex flex-col gap-4 p-4">
				...
				{document.querySelector("form")?.style.display !== "none" && (
					<p className="text-justify">
						El 85% de las personas en todo el mundo reutilizan las
						mismas contraseñas en varias cuentas. Esta práctica deja
						a las personas increíblemente vulnerables a los intentos
						de pirateo. Haz la prevención.
					</p>
				)}
				...
				>
							...
							<input
								...
								{...register("password", {
									...
									pattern: {
										value: /^\S*$/,
										message:
											"La contraseña no deben tener espacios.",
									},
								})}
								className="grow"
					...
					<div>
							...
							<input
								...
								{...register("passwordHint", {
									...
									maxLength: {
										value: 128,
										message:
											"La pista no puede tener más de 128 caracteres.",
									},
									validate: (value) => {
										if (value === watch("password")) {
						...
						{errors.passwordHint && (
							<span>{errors.passwordHint.message}</span>
						)}
					</div>
